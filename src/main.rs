...
use crate::{bus::Bus, cartridge::{Cartridge, Mapper}, cpu::CPU, ppu::PPU};
...
fn main() {
    ...
    let mid_offset = PPU::SCREEN_WIDTH * (PPU::SCREEN_HEIGHT / 2);
            ...
            match event {
                ...
                Event::KeyDown{keycode:Some(keycode),..}=>{
                    ...
                    match keycode {
                        ...
                        Keycode::Return =>{controller_state |= 1 << 3;}
                        Keycode::Up=>{controller_state |= 1 << 4;}
                        Keycode::Down =>{
